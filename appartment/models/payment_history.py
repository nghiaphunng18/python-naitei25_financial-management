...
class PaymentHistory(models.Model):
    ...
    bill = models.ForeignKey('Bill', on_delete=models.RESTRICT, db_column='bill_id')
    ...
    processed_by = models.ForeignKey('User', on_delete=models.SET_NULL, null=True, blank=True, db_column='processed_by')
