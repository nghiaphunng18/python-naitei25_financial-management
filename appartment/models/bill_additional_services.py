...
class BillAdditionalService(models.Model):
    ...
    bill = models.ForeignKey('Bill', on_delete=models.RESTRICT, null=True, blank=True, db_column='bill_id')
    additional_service = models.ForeignKey('AdditionalService', on_delete=models.RESTRICT, db_column='additional_service_id')
